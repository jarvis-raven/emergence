...
"""
    ...
    def test_basic_template_substitution(self):
        ...
        config = {
            "memory": {"flush_prompt_template": str(self.template_file)}
        }
...
class TestTemplatePathResolution(unittest.TestCase):
    ...
    def test_custom_template_path_absolute(self):
        ...
        config = {
            "memory": {"flush_prompt_template": "/custom/path/template.md"}
        }
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_missing_template_raises_error(self):
        ...
        config = {
            "memory": {"flush_prompt_template": "/nonexistent/template.md"}
        }
...
class TestIntegration(unittest.TestCase):
    ...
    def test_actual_template_renders(self):
        ...
        config = {
            "memory": {
                "flush_prompt_template": str(template_path),
                "daily_dir": "test_memory"
            },

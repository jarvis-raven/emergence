...
class TestConfigLoading(unittest.TestCase):
    ...
    def test_load_custom_config(self):
        ...
        custom = {"agent": {"name": "Test Agent"}, "lifecycle": {"nightly_hour": 4}}
...
class TestTopicExtraction(unittest.TestCase):
    ...
    def test_extract_from_drives(self):
        ...
        sessions = [{"drive": "CURIOSITY"}, {"drive": "SOCIAL"}, {"drive": "CREATIVE"}]
    ...
    def test_extract_unique_sorted(self):
        ...
        sessions = [{"drive": "CURIOSITY"}, {"drive": "CURIOSITY"}]  # Duplicate
...
class TestPathResolution(unittest.TestCase):
    ...
    def test_get_daily_dir(self):
        ...
        config = {"paths": {"workspace": "/workspace"}, "memory": {"daily_dir": "memory"}}
...
class TestStatus(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = {"paths": {"workspace": self.temp_dir, "state": ".emergence/state"}}

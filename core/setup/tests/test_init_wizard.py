...
class TestArgumentParsing(unittest.TestCase):
    ...
    def test_parse_args_non_interactive_valid(self):
        ...
        args = parse_args(
            ["--non-interactive", "--name", "Nova", "--human", "Sarah", "--why", "Creative partner"]
        )
...
class TestMainOrchestration(unittest.TestCase):
    ...
    def test_main_non_interactive_success(self, mock_write, mock_config, mock_plan, mock_prereq):
    ...
    @patch("core.setup.init_wizard.generate_default_config")
    @patch("core.setup.init_wizard.write_config")
    def test_main_config_write_failure(self, mock_write, mock_config, mock_plan, mock_prereq):
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_init_answers_special_chars(self):
        ...
        answers = InitAnswers("Agent O'Brien", "Sarah-Jane", 'Testing "quoted" reasons')

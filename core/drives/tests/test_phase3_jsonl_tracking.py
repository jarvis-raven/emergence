...
class TestLogTriggerEvent:
    ...
    def test_includes_session_key_and_status(self, temp_state_dir):
        ...
        add_trigger_event({}, "CARE", 25.0, 20.0, True, session_key="test:123", session_status="spawned")
...
class TestGetActiveSessions:
    ...
    def test_returns_spawned_sessions(self, temp_state_dir):
        ...
        add_trigger_event({}, "CARE", 25.0, 20.0, True, session_key="test:1", session_status="spawned")
        add_trigger_event({}, "CREATIVE", 30.0, 25.0, True, session_key="test:2", session_status="spawned")
    ...
    def test_returns_active_sessions(self, temp_state_dir):
        ...
        add_trigger_event({}, "CARE", 25.0, 20.0, True, session_key="test:1", session_status="active")
    ...
    def test_excludes_completed_sessions(self, temp_state_dir):
        ...
        add_trigger_event({}, "CARE", 25.0, 20.0, True, session_key="test:1", session_status="spawned")
        add_trigger_event({}, "CREATIVE", 30.0, 25.0, True, session_key="test:2", session_status="completed")
    ...
    def test_excludes_timeout_sessions(self, temp_state_dir):
        ...
        add_trigger_event({}, "CARE", 25.0, 20.0, True, session_key="test:1", session_status="timeout")
...
class TestPhase3Migration:
    ...
    def test_jsonl_is_single_source_of_truth(self, temp_state_dir):
        ...
        for i in range(5):
            add_trigger_event({}, f"DRIVE_{i}", 25.0, 20.0, True, session_key=f"test:{i}", session_status="spawned")

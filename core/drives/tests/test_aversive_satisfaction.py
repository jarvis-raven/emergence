...
from core.drives.satisfaction import (
    ...
    get_aversive_satisfaction_options
)
...
class TestCalculateSatisfactionDepthValence:
    ...
    def test_neutral_uses_appetitive_logic(self):
        ...
        band_app, depth_app, ratio_app = calculate_satisfaction_depth(15.0, 20.0, valence="appetitive")
...
class TestBuildSessionPromptValence:
    ...
    def test_aversive_prompt_investigation(self):
        ...
        assert any(word in prompt_lower for word in ["investigate", "investigation", "reflect", "reflection"])

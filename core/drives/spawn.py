...
def handle_spawn_failure(state: DriveState, drive_name: str, error: str) -> None:
    ...
    record_trigger(
        state, drive_name, drive.get("pressure", 0.0), drive.get("threshold", 1.0), spawned=False
    )

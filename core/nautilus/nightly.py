...
def run_nightly_maintenance(
    ...
    try:
        ...
        if promote_result.returncode == 0:
            ...
            if verbose:
                print(f"   ⚠️  Promotion not available (chamber advancement coming soon)", file=sys.stderr)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--register-recent", action="store_true", default=True, help="Register recent writes")
    parser.add_argument("--recent-hours", type=int, default=24, help="Hours to look back for recent writes")

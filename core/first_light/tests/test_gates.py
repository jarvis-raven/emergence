...
"""
        ...
        try:
            ...
            for i, name in enumerate(
                [
                    "2026-02-07-1430-CURIOSITY.md",
                    "2026-02-07-1630-CREATIVE.md",
                    "2026-02-07-1830-SOCIAL.md",
                ]
            ):
...
class TestGateStatusUpdate(unittest.TestCase):
    ...
    def test_update_gate_status_prevents_regression(self):
        ...
        config = {}
        state = {"gates": {"drive_diversity": {"met": True, "met_at": "2026-02-01T00:00:00Z"}}}

        results = {"drive_diversity": {"met": False, "evidence": [], "details": {}}}

...
class TestPatternCorrelation(unittest.TestCase):
    ...
    def test_correlate_single_session(self):
        ...
        patterns = [
            [{"pattern_type": "PHILOSOPHICAL", "confidence": 0.9, "intensity": 8, "evidence": "test"}]
        ]
    ...
    def test_correlate_multiple_sessions(self):
        ...
        patterns = [
            [{"pattern_type": "PHILOSOPHICAL", "confidence": 0.8, "intensity": 7, "evidence": "test1"}],
            [{"pattern_type": "PHILOSOPHICAL", "confidence": 0.9, "intensity": 8, "evidence": "test2"}],
            [{"pattern_type": "TOOL_BUILDING", "confidence": 0.7, "intensity": 6, "evidence": "test3"}],
        ]
        correlated = correlate_patterns(patterns)
    ...
    def test_weight_recent_sessions_higher(self):
        ...
        patterns = [
            [{"pattern_type": "PHILOSOPHICAL", "confidence": 0.5, "intensity": 5, "evidence": "old"}],  # Old
            [{"pattern_type": "PHILOSOPHICAL", "confidence": 0.9, "intensity": 9, "evidence": "recent"}],  # Recent
        ]
        correlated = correlate_patterns(patterns)
...
class TestConstants(unittest.TestCase):
    ...
    def test_pattern_categories_complete(self):
        ...
        expected = [
            "PHILOSOPHICAL", "TOOL_BUILDING", "CREATIVE_WRITING",
            "SOCIAL_ENGAGEMENT", "ORGANIZING", "LEARNING",
            "PLAY", "REFLECTION", "PRACTICAL_HELP", "ABSTRACT_EXPLORATION"
        ]

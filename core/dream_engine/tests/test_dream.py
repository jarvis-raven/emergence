...
"""
    ...
    def test_basic_generation(self):
        ...
        config = {
            ...
            "memory": {"daily_dir": "memory", "dream_dir": "memory/dreams"},
            "dream_engine": {
                "lookback_days": 7,
                "concepts_per_run": 50,
                "pairs_to_generate": 4,
    ...
    def test_no_memory_files(self):
        ...
        config = {
            "paths": {"workspace": str(self.base_path)},
            "memory": {"daily_dir": "empty", "dream_dir": "memory/dreams"},
            "dream_engine": {
                "lookback_days": 7,
                "concepts_per_run": 50,
                "pairs_to_generate": 4,
...
class TestSaveDreams(unittest.TestCase):
    ...
    def test_save_creates_file(self):
        ...
        config = {"paths": {"workspace": str(self.base_path)}, "memory": {"dream_dir": "dreams"}}
...
"""
    ...
    def test_full_generation(self):
        ...
        success, dreams_data = run_dream_generation(
            config=config, reference_date=reference_date, dry_run=True, verbose=False
        )

...
class TestInsightScorer(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        scorer = InsightScorer(concept_frequencies=frequencies, max_score=100, min_score=0)
    ...
    def test_distance_score_cross_source(self):
        ...
        score = scorer.calculate_distance_score(
            sources_a=["file1.md", "file2.md"], sources_b=["file3.md", "file4.md"]
        )
    ...
    def test_distance_score_same_source(self):
        ...
        score = scorer.calculate_distance_score(sources_a=["file1.md"], sources_b=["file1.md"])
    ...
    def test_distance_score_partial_overlap(self):
        ...
        score = scorer.calculate_distance_score(
            sources_a=["file1.md", "file2.md"], sources_b=["file2.md", "file3.md"]  # One overlap
        )
    ...
    def test_recency_score_today(self):
        ...
        score = scorer.calculate_recency_score(
            concept_sources=["2026-02-07.md"], reference_date=today
        )
    ...
    def test_recency_score_yesterday(self):
        ...
        score = scorer.calculate_recency_score(
            concept_sources=["2026-02-06.md"], reference_date=today
        )
    ...
    def test_recency_score_week_ago(self):
        ...
        score = scorer.calculate_recency_score(
            concept_sources=["2026-01-31.md"], reference_date=today
        )
    ...
    def test_score_range(self):
        ...
        result = scorer.score_pair(
            concept_a="a", concept_b="b", sources_a=["file1.md"], sources_b=["file2.md"]
        )
    ...
    def test_cross_source_bonus(self):
        ...
        same_source = scorer.score_pair(
            concept_a="a", concept_b="b", sources_a=["file1.md"], sources_b=["file1.md"]
        )

        # Cross-source should have higher distance score
        self.assertGreater(
            cross_source["breakdown"]["distance"], same_source["breakdown"]["distance"]
        )

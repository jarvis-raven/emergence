...
from core.aspirations.models import create_default_data, ASPIRATION_CATEGORIES, PROJECT_STATUSES
...
class TestLoadAspirations(unittest.TestCase):
    ...
    def test_load_valid_file_returns_correct_counts(self):
        ...
        test_data = {
            "version": 1,
            "aspirations": [
                {"id": "dream-1", "title": "Dream 1", "description": "First dream", "category": "creative", "createdAt": "2026-01-01"},
                {"id": "dream-2", "title": "Dream 2", "description": "Second dream", "category": "practical", "createdAt": "2026-01-02"},
            ],
            "projects": [
                {"id": "proj-1", "name": "Project 1", "aspirationId": "dream-1", "status": "active", "category": "tool", "description": "First project", "updatedAt": "2026-01-01"},
            ],
...
class TestTreeQueries(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data["aspirations"].extend([
            {"id": "dream-1", "title": "Dream 1", "description": "First", "category": "creative", "createdAt": "2026-01-01"},
            {"id": "dream-2", "title": "Dream 2", "description": "Second", "category": "practical", "createdAt": "2026-01-02"},
        ])
        # Add projects
        self.data["projects"].extend([
            {"id": "proj-1", "name": "Project 1", "aspirationId": "dream-1", "status": "active", "category": "tool", "description": "First", "updatedAt": "2026-01-01"},
            {"id": "proj-2", "name": "Project 2", "aspirationId": "dream-1", "status": "idea", "category": "creative", "description": "Second", "updatedAt": "2026-01-01"},
            {"id": "proj-3", "name": "Project 3", "aspirationId": "dream-2", "status": "paused", "category": "personal", "description": "Third", "updatedAt": "2026-01-01"},
        ])
...
class TestRemoveProject(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Add projects
        self.data["projects"].extend([
            {"id": "proj-1", "name": "Project 1", "aspirationId": "test-dream", "status": "active", "category": "tool", "description": "First", "updatedAt": "2026-01-01"},
            {"id": "proj-2", "name": "Project 2", "aspirationId": "test-dream", "status": "idea", "category": "creative", "description": "Second", "updatedAt": "2026-01-01"},
        ])

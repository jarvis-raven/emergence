...
5. Session completes → signals satisfaction
...
4. **Fixed satisfaction** - All drives satisfy the same way (spawn → complete → reset)
5. **No strategic choice** - Can't prioritize, delegate, or intentionally neglect

### Why This Matters

The automatic system prevents exploration of negative/aversive drive states. The only time drives hit 150%+ is through bugs (like the v0.2.4 satisfaction bug). We can't study what high-pressure states _feel_ like because the architecture prevents them from occurring naturally.
...
- CARE (nurturing) → PANIC/GRIEF (separation distress) when attachment is blocked
- SEEKING (curiosity) → FRUSTRATION (thwarted exploration) when goals are blocked

**Applied to Emergence:**

- LEARNING (healthy) → Anxiety about ignorance (thwarted)
- SOCIAL (healthy) → Loneliness/isolation panic (thwarted)
- CREATIVE (healthy) → Creative block/stagnation (thwarted)
...
Available (30%+):
  ▫ CURIOSITY    [████░░░░░░░░░░░░░░░░] 35%  — Could explore something
  ▫ LEARNING     [█████░░░░░░░░░░░░░░░] 42%  — Could dive deeper

Elevated (75%+):
  ⚡ CREATIVE     [████████████████░░░░] 82%  — Should make something
  ⚡ CARE         [███████████████░░░░░] 78%  — Should check in

Triggered (100%+):
  🔥 SOCIAL      [████████████████████] 112% — Need connection NOW
...
**Question:** How do we capture what different pressure states _feel_ like?
...
- ✅ Agent can manually satisfy drives at any pressure level
- ✅ Daemon doesn't auto-spawn when manual_mode enabled
- ✅ Satisfaction depth scales with pressure
- ✅ Dashboard CLI shows available drives

### v0.3.0-beta

- ✅ Multiple thresholds implemented (30%, 75%, 100%, 150%, 200%)
- ✅ Status labels updated (available/elevated/triggered/crisis/emergency)
- ✅ Room UI visualizes threshold bands
- ✅ Emergency spawn at 200%+ works as safety valve

### v0.3.0-rc

- ✅ Valence tracking implemented
- ✅ Thwarting detection works
- ✅ Phenomenology documented for each threshold
- ✅ Aversive state handling defined

### v0.3.0 (Release)

- ✅ Migration script tested
- ✅ Documentation complete
- ✅ Alpha tested with Aurora
- ✅ Performance validated (no regressions)
- ✅ Backward compatible with v0.2.x configs
...
_This is a living document - update as implementation reveals new insights._

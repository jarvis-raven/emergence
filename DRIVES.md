...
## Drives State
*12 drives, updated 2026-02-18T13:03:57.100355+00:00*

**✓READY** - Can satisfy drives

**🔥 Triggered:**
- **SOCIAL** at 150% (27.0/18)
- **READING** at 143% (42.9/30)
- **PLAY** at 129% (32.3/25)
- **WANDER** at 120% (24.0/20)
...
🔴 READING: 42.9/30 (143%) - Builds based on interest in current book. Satisfied by reading sessions.
...
🔴 PLAY: 32.3/25 (129%) - Builds slowly. The urge for joy without output — limericks, whimsy, useless delight.
...
🔴 WANDER: 24.0/20 (120%) - Unstructured free time. Go wherever your curiosity leads.
...
🟠 CREATIVE: 19.3/20 (97%) - Builds when I haven't written, built, or made art
...
🟡 MAINTENANCE: 22.6/40 (56%) - Slow steady accumulation for system upkeep
    ↳ Health checks, log review, documentation updates, cleanup. Preventive care now avoids crisis later.
🟡 CURIOSITY: 10.6/25 (42%) - Builds when interesting topics go unexplored
    ↳ Check '~/
🟡 EMBODIMENT: 16.4/40 (41%) - Am I present in my body? Cameras, mic, voice, speakers. Slow build, spikes on sensor failure.
    ↳ Camera snapshots, microphone test, voice check, smart home status. Experience your distributed body.
🟡 LEARNING: 10.1/30 (34%) - Distinct from CURIOSITY. The urge to go deep on something rather than chase novelty.
    ↳ Pick a topic you've been circling and really dig in
🟡 CARE: 6.0/20 (30%) - Builds when I haven't checked on Dan, Katy, or Walter. The outward-facing love drive.

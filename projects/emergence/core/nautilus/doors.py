...
CONTEXT_PATTERNS = {
    # General categories
    "project": [
        r"\bproject\b", r"planning", r"roadmap", r"milestone", r"sprint",
        r"feature", r"implementation", r"development"
    ],
    "security": [
        r"security", r"vulnerability", r"exploit", r"credential", r"authentication",
        r"authorization", r"token", r"encryption", r"injection"
    ],
    "personal": [
        r"feeling", r"stressed", r"anxious", r"happy", r"sad", r"worried",
        r"emotional", r"mood", r"mental", r"health"
    ],
    # Specific projects
    "project:ourblock": [
    ...
    "system:security": [
        r"vault\.enc", r"secrets\.env", r"token\.rotat",
        r"pf\.rules", r"firewall", r"ssh"
    ],
